...
The `age` of the dogs at adoption is the outcome with an event indicator called `adopted`. 
 ...
 * Strata are specified as part of the _outcome_ in it's own special syntax and function (`stratifySurv()`). 
